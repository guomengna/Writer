package com.example.guome.writer.view;
...
public class PullToRefreshView extends LinearLayout {
    ...
    public PullDownFreshInterface PullDownParent;
    public PullUpFreshInterface PullUpParent;
...
//			System.out.println(view);
        ...
        if (mAdapterView == null && mScrollView == null) {
            mAdapterView = (AdapterView<?>) getChildAt(1);
            // throw new IllegalArgumentException(
...
//		// 当header view的topMargin>=0时，说明已经完全显示出来了,修改header view 的提示状态
    ...
    private void headerRefreshing() {
        ...
        System.out.println(mHeaderTextView.isShown());
        mHeaderTextView.setText(R.string.pull_to_refresh_refreshing_label);
        if (mOnHeaderRefreshListener != null) {
            mOnHeaderRefreshListener.onHeaderRefresh(this);
        }
        PullDownParent.PullDownFresh();
    }
